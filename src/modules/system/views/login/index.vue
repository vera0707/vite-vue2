      ...
      >
        ...
        <el-form-item prop="vercode">
          <el-input
            ...
            maxlength="4"
          ></el-input>
          <img class="verify-code vtb" :src="verifyCodeSrc" @click="changeVerify" alt="验证码" />
        </el-form-item>
        ...
        <el-form-item class="txr log mt5">
          <el-button :loading="loading" type="primary" class="log-btn" native-type="submit">登录</el-button>
...
export default {
  ...
  data(){
    return {
      verifyCodeSrc: `/hb-weber/usermng/genVerificationCode?t=${Math.random()
        * 10000}`,
      saveAccount: true,
      loginForm: {},
  ...
  methods:{
    changeVerify() {
      this.verifyCodeSrc = `/hb-weber/usermng/genVerificationCode?t=${Math.random()
        * 10000}`;
    },
    submit(e) {
       e.preventDefault();
